...
/* login.html.twig */
class __TwigTemplate_33de6dfd02a8dea6d804d711707e96a8 extends Template
{
    private $source;
    private $macros = [];
    ...
    <form action=\"";
        ...
        echo "\" method=\"post\">
        <label for=\"username\">ID Utilisateur:</label>
        ...
        // line 17
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_login_redirect");
        echo "\">
...
";
    ...
    {
        return array (  112 => 17,  104 => 12,  99 => 10,  96 => 9,  90 => 7,  87 => 6,  77 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    <form action=\"{{ path('app_login') }}\" method=\"post\">
        ...
        <input type=\"hidden\" name=\"_target_path\" value=\"{{ path('app_login_redirect') }}\">

        <button type=\"submit\">login</button>
    </form>
{% endblock %}
", "login.html.twig", "/Users/coulbeaf/PhpstormProjects/sae4/templates/login.html.twig");
    }
}
