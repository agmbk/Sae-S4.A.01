...
return [
    ...
    'helloWorld' => [['name'], ['_controller' => 'App\\Controller\\HomeController::helloWorld'], [], [['variable', '/', '[^/]++', 'name', true], ['text', '/helloWorld']], [], [], []],
    ...
    'app_login_redirect' => [[], ['_controller' => 'App\\Controller\\LoginController::loginRedirect'], [], [['text', '/login/redirect']], [], [], []],
