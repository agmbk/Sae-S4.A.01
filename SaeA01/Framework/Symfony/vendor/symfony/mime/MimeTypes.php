...
final class MimeTypes implements MimeTypesInterface
{
    ...
    private const MAP = [
        ...
        'application/vnd.1000minds.decision-models+xml' => ['1km'],
        ...
        'models/iges' => ['igs', 'iges'],
        'models/mesh' => ['msh', 'mesh', 'silo'],
        'models/mtl' => ['mtl'],
        'models/obj' => ['obj'],
        'models/step+zip' => ['stpz'],
        'models/step-xml+zip' => ['stpxz'],
        'models/stl' => ['stl'],
        'models/vnd.collada+xml' => ['dae'],
        'models/vnd.dwf' => ['dwf'],
        'models/vnd.gdl' => ['gdl'],
        'models/vnd.gtw' => ['gtw'],
        'models/vnd.mts' => ['mts'],
        'models/vnd.opengex' => ['ogex'],
        'models/vnd.parasolid.transmit.binary' => ['x_b'],
        'models/vnd.parasolid.transmit.text' => ['x_t'],
        'models/vnd.sap.vds' => ['vds'],
        'models/vnd.usdz+zip' => ['usdz'],
        'models/vnd.valve.source.compiled-map' => ['bsp'],
        'models/vnd.vtu' => ['vtu'],
        'models/vrml' => ['wrl', 'vrml', 'vrm'],
        'models/x.stl-ascii' => ['stl'],
        'models/x.stl-binary' => ['stl'],
        'models/x3d+binary' => ['x3db', 'x3dbz'],
        'models/x3d+fastinfoset' => ['x3db'],
        'models/x3d+vrml' => ['x3dv', 'x3dvz'],
        'models/x3d+xml' => ['x3d', 'x3dz'],
        'models/x3d-vrml' => ['x3dv'],
    ...
    private const REVERSE_MAP = [
        '1km' => ['application/vnd.1000minds.decision-models+xml'],
        ...
        'bsp' => ['models/vnd.valve.source.compiled-map'],
        'btif' => ['image/prs.btif'],
        ...
        'glb' => ['models/gltf-binary'],
        'gltf' => ['models/gltf+json'],
        ...
        'obj' => ['application/x-tgif', 'models/obj'],
        'ocl' => ['text/x-ocl'],
        'oda' => ['application/oda'],
        ...
        'stl' => ['application/vnd.ms-pki.stl', 'models/stl', 'models/x.stl-ascii', 'models/x.stl-binary'],
        'stm' => ['audio/x-stm'],
        'stpxz' => ['models/step-xml+zip'],
        'stpz' => ['models/step+zip'],
        ...
        'x3d' => ['models/x3d+xml'],
        'x3db' => ['models/x3d+binary', 'models/x3d+fastinfoset'],
        'x3dbz' => ['models/x3d+binary'],
        'x3dv' => ['models/x3d+vrml', 'models/x3d-vrml'],
        'x3dvz' => ['models/x3d+vrml'],
        'x3dz' => ['models/x3d+xml'],
        'x3f' => ['image/x-sigma-x3f'],
        'x_b' => ['models/vnd.parasolid.transmit.binary'],
        'x_t' => ['models/vnd.parasolid.transmit.text'],
